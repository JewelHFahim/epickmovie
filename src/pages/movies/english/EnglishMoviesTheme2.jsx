...
import { useEnglishMovieListTheme2Query } from "../../../redux/features/movies/movieApi";
...
const EnglishMoviesTheme2 = () => {
  ...
  const { data: perPageEnglishMovies, isLoading } = useEnglishMovieListTheme2Query(currentP);
