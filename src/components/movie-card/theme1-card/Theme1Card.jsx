...
const Theme1Card = ({ item }) => {
  ...
  return (
    <div onClick={() => handleRedirect()}>
      ...
      <div className="relative min-h-full lg:w-[165px] lg:h-[260px] rounded-[10px] bg-slate-400 overflow-hidden flex flex-col justify-center items-center posterImg playBtnCont cursor-pointer">
        
        <img src={item?.poster_image_url} alt="" className="object-cover w-full h-full rounded-[10px] posterImg" />
        ...
        <div className="z-50 absolute bottom-2 text-white px-5">
          <p className="text-[20px] lg:text-[13px] font-bold text-center">
            {item?.post_title}
          </p>
        </div>
