  ...
  return (
    <div className="hidden lg:block  w-[30%] bg-[#1F1F22] p-4">
      ...
      <div className="w-[299px] h-[193px] bg-[#27272A] flex flex-col">
        <p className="text-white font-inter font-[500] mt-[39px] ml-[18px]"> Join Our Telegram </p>
        <hr className="w-full bg-[#494949] opacity-[.4]" />
        <Link to={telegramLink} target="_blank" rel="noopener noreferrer">
          <img src={joinTelegran} alt="" className="mt-[10px] w-[268px] h-[104px] mx-auto"/>
        </Link>
      </div>

      {/* Latest Movies */}
      <div className="my-5">
        <h2 className="text-[#B8B8B8] font-aclonica my-2">Latest Movies</h2>
        <LatestMoviesCard />
      </div>
      ...
      <div className="w-[299px] h-[271px] bg-[#27272A] mt-[25px]">
        <p className="px-[34px] pt-[15px] font-[500] text-[#F4F4F4C9] opacity-[.79] m-0"> Ads </p>
        <img src={ads} alt="" />
      </div>
