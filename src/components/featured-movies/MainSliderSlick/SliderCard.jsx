...
const SliderCard = ({ item }) => {
  ...
  return (
    <div className="bg-gradient-to-t from-[#ff1818] to-[#fdd506] lg:w-[185px] h-[420px] lg:h-[338px] p-[4px] lg:p-[2px] rounded-[10px] relative playBtnCont overflow-hidden">
      <button
      ...
      /> */}
        <img
          ...
          alt="poster"
          className="w-full rounded-tr-[10px] rounded-tl-[10px] posterImg lg:h-[70%] object-cover lg:object-cover"
        />

        <p className="hidden lg:block lg:h-[30%] text-center text-white font-[700] text-[25px] lg:leading-[20px] lg:text-[12px] p-4 lg:p-2 font-alef ">
          {item?.post_title?.length <= 45
            ? item?.post_title
            : `${item?.post_title?.slice(0, 45)} ...`}
        </p>
