...
const CardTheme3 = ({ item }) => {
  ...
  const handleRedirect = useRedirect(url, maskLink);
  const customizedDate = item?.updated_at ? formatDate(item.updated_at) : "No date available";


  return (
    <button
      onClick={() => handleRedirect()}
      className="w-full lg:w-[160px] lg:h-[285px] p-1 cardContainer cursor-pointer"
    >
      ...
      <div className="mt-2 lg:mt-1 h-[26%] text-left">
