...
const NavbarTheme2 = () => {
  ...
  return (
    <div className="hidden w-full h-[144px] bg-[#444444] lg:flex items-center">
      <div className="lg:w-[78vw] lg:min-w-[1500px] mx-auto flex flex-col items-center gap-3">
        <Link to="/">
          <img src={siteLogo} alt="site-logo" className="w-[280px] h-[53px]" />
        </Link>
        ...
        <div className="flex items-center gap-x-5">
          ...
          <form
            ...
            className="w-[332px] py-2 rounded-md flex items-center bg-[#DEDEDE] ml-5"
          >
            <input
              type="text"
